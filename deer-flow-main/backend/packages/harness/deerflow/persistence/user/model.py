...
class NewAPIAccountSnapshotRow(Base):
    __tablename__ = "newapi_account_snapshots"
    ...
    newapi_sub: Mapped[str] = mapped_column(String(128), nullable=False, index=True)
    ...
    __table_args__ = (
        Index("idx_newapi_account_snapshots_sub", "newapi_sub", unique=False),
    )

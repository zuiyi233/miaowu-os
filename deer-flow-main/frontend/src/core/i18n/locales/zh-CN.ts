...
export const zhCN: Translations = {
  ...
  novel: {
    title: "小说工作室",
    description: "创建和管理你的小说写作项目",
    newNovel: "新建小说",
    noNovelsYet: "还没有小说",
    noNovelsDescription: "开始你的写作之旅，创建第一部小说",
    ...
    update: "更新",
    name: "名称",
    namePlaceholder: (entity: string) => `输入${entity}名称...`,
    fieldPlaceholder: (field: string) => `输入${field}...`,
    entityDescription: "描述",
    descriptionPlaceholder: (entity: string) => `描述${entity}...`,
    type: "类型",
    selectType: "选择类型...",
    settingTypeCity: "城市",
    ...
    itemTypeOther: "其他",
    noEntities: (label: string) => `还没有${label}。点击'添加'创建一个。`,
    noEntitiesClickAdd: "还没有实体。点击添加创建一个。",
    deleteConfirm: (entity: string) => `确定要删除这个${entity}吗？`,
    volumes: "卷",
    chapters: "章",
    words: "字",
    noVolumesYet: "还没有卷。点击'添加卷'开始。",
    noVolumesClickAdd: "还没有卷。点击'添加卷'开始。",
    addVolume: "添加卷",
    addChapter: "添加章节",
    volumeTitle: "卷标题...",
    chapterTitle: "章节标题...",
    ...
    deleteVolumeConfirm: "删除此卷及其所有章节？",
    deleteChapterConfirm: "删除此章节？",
    chapterOutline: "章节大纲",
    writingTarget: "写作目标",
    noNovelSelected: "选择小说",
    noNovelData: "暂无小说数据",
    promptTemplates: "提示词模板",
    dataManagement: "数据管理",
    exportData: "导出数据",
    exportDataDescription: "导出你的小说、角色和设定",
    importData: "导入数据",
    importDataDescription: "导入之前导出的数据",
    exportJson: "导出为 JSON",
    exportCsv: "导出为 CSV",
    fullBackup: "完整备份",
    importJsonFile: "导入 JSON 文件",
    clearAllData: "清除所有数据",
    clearAllDataConfirm: "确定吗？这将删除所有数据。",
    clearAllDataSuccess: "数据已清除",
    exportSuccess: "数据导出成功",
    exportFailed: "导出失败",
    importSuccess: "数据导入成功",
    importFailed: "导入失败",
    importProcessing: "正在导入数据...",
    importStatusTitle: "导入状态",
    importStatusDescription: "正在处理你的导入请求...",
    newTemplate: "新建",
    editTemplate: "编辑模板",
    createTemplate: "创建模板",
    createTemplateDescription: "创建一个新的AI辅助提示词模板。",
    updateTemplateDescription: "更新AI辅助提示词模板。",
    templateName: "模板名称",
    templateNamePlaceholder: "例如，我的小说大纲提示词",
    promptContent: "提示词内容",
    promptContentPlaceholder: "在此编写你的提示词。使用{变量}表示动态内容。",
    templateVariableHint: "使用{变量}语法表示模板变量（例如，{角色名称}，{场景描述}）",
    noTemplatesFound: "没有找到模板。点击新建创建一个。",
    noTemplatesClickNew: "没有找到模板。点击新建创建一个。",
    builtIn: "内置",
    outlineGen: "大纲生成",
    continueWrite: "继续写作",
    polish: "文字润色",
    ...
    addRelationshipDescription: "创建两个实体之间的连接。",
    sourceEntity: "源实体",
    targetEntity: "目标实体",
    selectSource: "选择源实体...",
    selectTarget: "选择目标实体...",
    relationshipType: "关系类型",
    relationshipDescription: "描述（可选）",
    relationshipDescriptionPlaceholder: "描述关系...",
    friend: "朋友",
    enemy: "敌人",
    family: "家人",
    lover: "恋人",
    custom: "自定义",
    noTimelineEvents: "还没有时间线事件。点击'添加事件'创建一个。",
    noTimelineEventsClickAdd: "还没有时间线事件。点击'添加事件'创建一个。",
    addEvent: "添加事件",
    addEventTitle: "添加时间线事件",
    addEventDescription: "在你的故事时间线中创建一个新事件。",
    eventTitle: "事件标题",
    timeDisplay: "时间显示",
    timeDisplayPlaceholder: "例如，帝国历305年",
    sortValue: "排序值（年份 * 100）",
    sortValueHint: "排序值（年份 * 100）",
    eventType: "类型",
    eventDescription: "描述",
    eventDescriptionPlaceholder: "描述事件...",
    backstory: "背景故事",
    plot: "情节",
    historical: "历史",
    aiWriting: "AI 正在写作...",
    ...
    typeMessage: "输入你的消息...",
    selectedText: "已选择",
    noContextEntities: "没有选择实体",
    contextEntities: "上下文实体",
    continue: "继续",
    expandScene: "扩写",
    creating: "创建中...",
    createNewNovelTitle: "创建新小说",
    createNewNovelDescription: "开始你的写作之旅，创建一个新的小说项目。",
    novelTitle: "标题",
    novelTitlePlaceholder: "输入小说标题...",
    novelOutline: "大纲",
    novelOutlinePlaceholder: "简要描述你的小说...",

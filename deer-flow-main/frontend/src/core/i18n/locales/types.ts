...
interface NovelTranslations {
  ...
  ttsChoosePlaybackEngine: string;
  ttsDeviceReadAloud: string;
  ttsAiAudiobook: string;
  ttsDeviceReadAloudHint: string;
  ttsAiAudiobookHint: string;
  ttsDeviceVoice: string;
  ttsDeviceVoiceUnavailable: string;
  ttsDeviceRate: string;
  ttsDevicePitch: string;
  ttsProvider: string;
  ttsVoice: string;
  ...
  ttsErrorMissingConfig: string;
  ttsErrorInvalidRequest: string;
  ttsErrorUnsupportedProvider: string;
  ttsErrorUnsupportedModel: string;
  ttsErrorUnsupportedEndpoint: string;
  ttsErrorAuthFailed: string;
  ttsErrorRateLimited: string;
  ttsErrorProviderTimeout: string;
  ttsErrorProviderFailed: string;
  ttsErrorStorageUnavailable: string;
  ttsErrorQuotaExceeded: string;
  ttsErrorGenerationCancelled: string;
  ttsChapterAudio: string;
  ttsCacheHit: string;
  ttsCacheMiss: string;
  ttsGenerateChapterAudio: string;
  ttsReuseChapterAudio: string;
  ttsRegenerateChapterAudio: string;
  ttsDownloadAudio: string;
  ttsBrowserExportMp3: string;
  ttsBrowserExportHint: string;
  ttsCancelJob: string;
  ttsRetryJob: string;
  ttsNarrationInstructions: string;
  ttsNarrationInstructionsPlaceholder: string;
  ttsRoleVoices: string;
  ttsNarrationMode: string;
  ttsChooseNarrationMode: string;
  ttsSingleNarrator: string;
  ttsAiMultivoice: string;
  ttsNarrationPlan: string;
  ttsNarrationPlanEmpty: string;
  ttsLoadNarrationPlan: string;
  ttsGenerateNarrationPlan: string;
  ttsGenerateChapterWithPlan: string;
  ttsPlanSummary: (speakers: number, segments: number) => string;
  ttsPlanConfidence: (percent: number) => string;
  ttsLowConfidenceWarnings: (count: number) => string;
  ttsUnsupportedHint: string;

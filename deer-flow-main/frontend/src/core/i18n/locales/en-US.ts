...
export const enUS: Translations = {
  ...
  novel: {
    ...
    noNovelsDescription: "Start by creating a new novel to organize your story.",
    createNewNovelTitle: "Create a new novel",
    createNewNovelDescription: "Set up a title and outline for your new novel.",
    ...
    confirmDeleteDescription: "Are you sure you want to delete this novel? All chapters, characters, settings and other data will be permanently deleted. This action cannot be undone.",
    batchDeleteTitle: "Batch Delete Confirmation",
    batchDeleteDescription: "Are you sure you want to delete the selected novels? All related data will be permanently deleted. This action cannot be undone.",
    deleted: "Deleted",

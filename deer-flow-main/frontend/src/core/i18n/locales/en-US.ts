...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to Miaowu OS, an AI workspace for creators. With built-in and custom skills, Miaowu OS helps you search the web, analyze data, generate artifacts, and write long-form fiction.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Miaowu OS. With customized skills,\nMiaowu OS can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Miaowu OS is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Miaowu OS could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "Miaowu OS official website",
    githubTooltip: "Miaowu OS",
    settingsAndMore: "Settings and more",
    visitGithub: "Miaowu OS",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About Miaowu OS",
    logout: "Log out",
  },
  ...
  novel: withNovelDefaults(
    {
      ...
      title: "Novel",
      description: "Manage novels, characters, outlines, and prompt templates.",
      noNovelsYet: "No novels yet",
      noNovelsDescription:
        "Start by creating a new novel to organize your story.",
      createNewNovelTitle: "Create a new novel",
      createNewNovelDescription:
        "Set up a title and outline for your new novel.",
      novelTitle: "Novel title",
      novelTitlePlaceholder: "Enter a novel title",
      novelOutline: "Novel outline",
      novelOutlinePlaceholder: "Write a short outline for the novel",
      defaultVolumeName: "Volume 1",
      ...
      factionSingular: "Faction",
      settingSingular: "Setting",
      itemSingular: "Item",
      name: "Name",
      namePlaceholder: (label: string) => `Enter ${label} name`,
      type: "Type",
      selectType: "Select a type",
      entityDescription: "Description",
      descriptionPlaceholder: (label: string) => `Describe ${label}`,
      fieldPlaceholder: (label: string) => `Enter ${label}`,
      fieldAge: "Age",
      fieldGender: "Gender",
      ...
      itemTypeTechDevice: "Tech device",
      itemTypeCommonItem: "Common item",
      itemTypeOther: "Other",
      settingTypeCity: "City",
      settingTypeBuilding: "Building",
      settingTypeNaturalLandscape: "Natural landscape",
      settingTypeRegion: "Region",
      settingTypeOther: "Other",
      noNovelData: "No novel data yet",
      addVolume: "Add volume",
      noVolumesYet: "No volumes yet",
      volumePlaceholder: "Volume title",
      chapterPlaceholder: "Chapter title",
      deleteVolumeConfirm: "Are you sure you want to delete this volume?",
      deleteChapterConfirm: "Are you sure you want to delete this chapter?",
      chapterOutline: "Chapter outline",
      writingTarget: "Writing target",
      ...
      createTemplateDescription: "Create a new prompt template for this novel.",
      editTemplate: "Edit template",
      updateTemplateDescription: "Update the selected prompt template.",
      templateName: "Template name",
      templateNamePlaceholder: "Enter template name",
      templateVariableHint: "Use {variables} in the prompt content.",
      promptContent: "Prompt content",
      promptContentPlaceholder: "Write the prompt content here",
      outlineGen: "Outline generation",
      extraction: "Extraction",
      importData: "Import data",
      importDataDescription: "Import novel data from a JSON file.",
      importJsonFile: "Import JSON file",
      importProcessing: "Importing...",
      importStatusTitle: "Import status",
      importStatusDescription: "Import progress and result will appear here.",
      importSuccess: "Import succeeded",
      importFailed: "Import failed",
      exportData: "Export data",
      exportDataDescription: "Export novel data to a file.",
      exportCsv: "Export CSV",
      exportJson: "Export JSON",
      exportSuccess: "Export succeeded",
      exportFailed: "Export failed",
      clearAllData: "Clear all data",
      clearAllDataConfirm: "Are you sure you want to clear all novel data?",
      clearAllDataSuccess: "All novel data cleared",
      ...
      confirmDeleteDescription:
        "Are you sure you want to delete this novel? All chapters, characters, settings and other data will be permanently deleted. This action cannot be undone.",
      batchDeleteTitle: "Batch Delete Confirmation",
      batchDeleteDescription:
        "Are you sure you want to delete the selected novels? All related data will be permanently deleted. This action cannot be undone.",
      deleted: "Deleted",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Miaowu OS",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Miaowu OS faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Miaowu OS looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Miaowu OS automatically learns from your conversations in the background. These memories help Miaowu OS understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Miaowu OS.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Miaowu OS only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
